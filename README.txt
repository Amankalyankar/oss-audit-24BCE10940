In this OSSCapstoneProject we have made 5 shell scripts and ran them on Cachy OS - a Linux distro , to execute these shell scripts use the steps mentioned below - 
...
nano script3_disk_permission_auditor.sh
...
nano script5_manifesto_generator.sh
